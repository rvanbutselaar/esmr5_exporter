    ...
    def get_p1_metrics(self, p1_lines, metrics):
        ...
        for p1_line in p1_list:
            ...
            if "1-0:1.8.1" in p1_line:
                ...
                # logging.debug(
                #     "p1_total_electricity_used_rate_1: {}".format(
                ...
                logging.debug(
                    "p1_total_electricity_used_rate_2: {}".format(
                        markup_helper(p1_line)
                    )
                )
                ...
                logging.debug(
                    "p1_total_electricity_provided_rate_1: {}".format(
                        markup_helper(p1_line)
                    )
                )
                ...
                logging.debug(
                    "p1_total_electricity_provided_rate_2: {}".format(
                        markup_helper(p1_line)
                    )
                )
                ...
                logging.debug(
                    "p1_total_electricity_used: {}".format(markup_helper(p1_line))
                )
                ...
                logging.debug(
                    "p1_total_electricity_provided: {}".format(markup_helper(p1_line))
                )
                metrics["p1_total_electricity_provided"].add_metric(
                    ["Rozensingel"], markup_helper(p1_line)
                )
            elif "1-0:32.7.0" in p1_line:
                logging.debug("p1_l1_voltage: {}".format(markup_helper_float(p1_line)))
                metrics["p1_l1_voltage"].add_metric(
                    ["Rozensingel"], markup_helper_float(p1_line)
                )
            elif "1-0:52.7.0" in p1_line:
                logging.debug("p1_l2_voltage: {}".format(markup_helper_float(p1_line)))
                metrics["p1_l2_voltage"].add_metric(
                    ["Rozensingel"], markup_helper_float(p1_line)
                )
            elif "1-0:72.7.0" in p1_line:
                logging.debug("p1_l3_voltage: {}".format(markup_helper_float(p1_line)))
                metrics["p1_l3_voltage"].add_metric(
                    ["Rozensingel"], markup_helper_float(p1_line)
                )
            elif "0-0:96.14.0" in p1_line:
                logging.debug(
                    "p1_current_tarrif: {}".format(markup_helper_tarrif(p1_line))
                )
    ...
    def collect(self):
        metrics = {
            "p1_total_electricity_used_rate_1": GaugeMetricFamily(
                "p1_total_electricity_used_rate_1", "Gebruik elektra dal"
            ),
            "p1_total_electricity_used_rate_2": GaugeMetricFamily(
                "p1_total_electricity_used_rate_2", "Gebruik elektra piek"
            ),
            "p1_total_electricity_provided_rate_1": GaugeMetricFamily(
                "p1_total_electricity_provided_rate_1", "Geleverd elektra dal"
            ),
            "p1_total_electricity_provided_rate_2": GaugeMetricFamily(
                "p1_total_electricity_provided_rate_2", "Geleverd elektra piek"
            ),
            "p1_total_electricity_used": GaugeMetricFamily(
                "p1_total_electricity_used", "Totaal gebruik elektra"
            ),
            "p1_total_electricity_provided": GaugeMetricFamily(
                "p1_total_electricity_provided", "Totaal geleverd elektra"
            ),
            "p1_l1_voltage": GaugeMetricFamily(
                "p1_l1_voltage", "Totaal geleverd elektra"
            ),
            "p1_l2_voltage": GaugeMetricFamily(
                "p1_l2_voltage", "Totaal geleverd elektra"
            ),
            "p1_l3_voltage": GaugeMetricFamily(
                "p1_l3_voltage", "Totaal geleverd elektra"
            ),
            "p1_current_tarrif": GaugeMetricFamily(
                "p1_current_tarrif", "Totaal geleverd elektra"
            ),
        }
